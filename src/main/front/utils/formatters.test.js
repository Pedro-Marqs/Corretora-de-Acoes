...
import { currencyInputToDecimal, formatBrasiliaDateTime, formatCurrency, formatCurrencyInput, formatMoney } from './formatters.js'
describe('formatters', () => {
  ...
  it('formata valores de mercado em BRL e USD com duas casas', () => {
    expect(formatMoney('1238.05', 'BRL')).toMatch(/R\$\s*1\.238,05/)
    expect(formatMoney('225.10', 'USD')).toMatch(/US\$\s*225,10/)
    expect(formatMoney('5.50', 'BRL', false)).toBe('5,50')
  })
